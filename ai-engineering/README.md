...
* **[AI System Architecture](ai-system-architecture.md)**: High-level architecture for LLM, RAG, and agent orchestration.
* **[Evaluation Metrics](evaluation-metrics.md)**: Practical metrics framework with formulas, workflows, and examples.